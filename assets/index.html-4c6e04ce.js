import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as a,c as v,b as i,d as n,e as r,a as e}from"./app-f4353c56.js";const c={},m=e(`<p>建议使用8.0.17及之后的版本，更新的内容比较多。</p><h2 id="新增降序索引" tabindex="-1"><a class="header-anchor" href="#新增降序索引" aria-hidden="true">#</a> 新增降序索引</h2><p>MySQL在语法上很早就已经支持降序索引，但实际上创建的仍然是升序索引，如下MySQL 5.7 所示，c2字段降序，但是从show create table看c2仍然是升序。8.0可以看到，c2字段降序。只有Innodb存储引擎支持降序索引。</p><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code># ====MySQL 5.7演示====
